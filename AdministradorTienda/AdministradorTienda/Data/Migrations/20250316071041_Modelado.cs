        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usuarios_AspNetUsers_IdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuentasClientes", x => x.IdCuenta);
                    table.ForeignKey(
                        name: "FK_CuentasClientes_Clientes_IdCliente",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPedido = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdCliente = table.Column<int>(type: "int", nullable: false),
                    IdUsuarioGestor = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pedidos_Usuarios_IdUsuarioGestor",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pagos_Usuarios_IdUsuarioRegistro",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CuentasClientes_IdCliente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pedidos_IdUsuarioGestor",
                table: "Pedidos",
